...
Ids_Dev = {sudos.Id_DevOLIFIcom,bot_id}
...
if Dev_OLIFIcom_User(user_id) == true then
...
if Get_info then
local TextS = "\n⌔︙قائمه ملفات متجر سورس OLIFIcom\n⌔︙الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
...
send(msg.chat_id_, msg.id_,'*⌔︙ عدد المجموعات الان ← { '..#group..' } مجموعه '..OLIFIcom..''..taha..'\n⌔︙اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
𓂅 .𝑺𝑶𝑼𝑹𝑪𝑬𐇵𝑹𝑨𝑲𝑶𝑵
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [𝑺𝑶𝑼𝑹𝑪𝑬𐇵𝑹𝑨𝑲𝑶𝑵](t.me/OLIFIcom)

𓂅 . [𝑼𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒓𝒖𝒄𝒆 ](t.me/OLIFIcom)     
